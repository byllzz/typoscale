    ...
    <>
      <div className={`sticky top-0 z-10 backdrop-blur-sm border-b transition-colors duration-300 ${
        ...
        <div className="p-2 flex items-center justify-between">
          {/* left */}
          <div className="flex items-center relative left-[6px]">
            <div className="w-10 h-10 relative left-0.5 flex items-center justify-center flex-shrink-0">
              <img src={logo} className="h-full w-full" alt="TypoScale logo" />
            </div>
            <div>
              <h1 className={`font-semibold text-base tracking-tight transition-colors duration-300 ${
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 py-6 space-y-8">
        {/* Font Pairing */}
        <section>
          <h2 className={`text-xs font-semibold uppercase tracking-widest mb-4 transition-colors duration-300 ${
          ...
          <div className="space-y-5">
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className={`text-xs font-medium uppercase tracking-widest transition-colors duration-300 ${
                  darkMode ? 'text-stone-400' : 'text-stone-500'
                }`}>
                  Base Size
                </label>
        ...
        <section className={`border-t pt-6 transition-colors duration-300 ${
