...
export function PreviewPane({ steps }: PreviewPaneProps) {
  ...
  return (
    ...
    >
      {/* Preview text input - fixed header */}
      <div className="border-b px-4 sm:px-6 py-3 flex flex-col sm:flex-row items-start sm:items-center gap-3 transition-colors duration-300 flex-shrink-0" style={{ borderColor }}>
